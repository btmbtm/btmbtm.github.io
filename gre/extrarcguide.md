...
PART I - MASTER UNDERSTANDING THE PASSAGE

1. READ, SKIM, SUMMARY (7 SAGE MEMORY METHOD) ALSO ID MAIN POINT (7-12 PASSAGES/ CAN MAKE DAILY HABIT W/ ARTICLES)(MAIN PURPOSE IS TO READ FOR STRUCTURE AND MAKE SURE YOU ARE REMEMBERING WTF THE PASSAGE IS ABOUT)
2. READ, SKIM, SUMMARY -> ATTEMPT QUESTIONS W/ SUMMARY NOTES ONLY(OR BLIND) TO SEE HOW GOOD YOUR SUMMARY/MEMORY (7-12 PASSAGES) (SHOW IMPORTANCE OF HAVING ACCESS TO PASSAGE -> HUMAN MEMORY BAD)
3. TRY JUMPING TO RELEVANT SECTION WITHOUT READING CLOSELY (A FEW QUESTIONS JUST TO SHOW ITS HARD)
3. READ -> LEARN TO JUMP TO RELEVANT SECTION (USE QUESTIONS FOR SEARCH)(LOTS OF Q'S OK)

PART II - MASTER QUESTIONS

1. LEARN COMMON WRONG TYPES (MAKE OWN CHEATSHEET) 
2. PRACTICE IDING BAD ANSWER CHOICES BLINDLY (JUST GO THRU QUESTIONS, ELIM ANSWERS AND GUESS)(SHOW HOW BAD SOME ASNWERS ARE)(USE CHEATSHEET)(DO LOTS OF Q'S WRONG DOESN'T MATTER)(GOOD TO QUESTION RIGHT ANSWERS ALSO!)(ID REALLY BAD ANSWERS)(SEE IF YOU CAN GET TO 50% RIGHT >_<)
4. PRACTICE IDING BAD ANSWER CHOICES THEN JUMPING INTO PASSAGE W/ FRAMEWORK (THIS MAY BE USEFUL METHOD FOR SOME PEOPLE WHO NEED PRIMING BEFORE JUMPING INTO A PASSAGE)

PART III - PUTTING IT ALL TOGETHER

1. READ, SKIM, SUMMARIZE -> ANSWER QUESTIONS PROVING WRONG/RIGHT (EXPLICIT/WRITE DOWN (SHORT NOTES) OF WRONG TYPE / UNTIMED UNTIL COMFORATBLE GETTING > 70% RIGHT)
2. DO SINGLE PASSAGES TIMED (ID WRONG TYPES MENTALLY QUICKLY) W/ BLIND REVIEW (ID WEIRD Q'S)
3. DO FULL SECTION TIMED W/ BLIND REVIEW ALWAYS!
